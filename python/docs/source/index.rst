...
.. meta::
   :description: COSMolKit is a Rust-native cheminformatics toolkit with Python bindings for SMILES, SMARTS, fingerprints, conformers, InChI, force fields, and molecular IO.
