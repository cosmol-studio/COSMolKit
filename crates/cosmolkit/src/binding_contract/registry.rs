...
binding_contract! {
    pub static BINDING_CONTRACT = [
        ...
        // IO-v2000_read canonical Rust construction contract. These entries
        // remain registered/unsupported until the detached IO and mol-post
        // gates are closed and the thin facade methods actually exist.
        // MolBlockReadParams defaults are: sanitize=true,
        // remove_hydrogens=true, strict_parsing=true,
        // expand_attachment_points=false, coordinate_mode=Preserve.
        #[cfg(feature = "io")]
        {
