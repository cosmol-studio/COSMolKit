...
fn public_descriptor_from_source(desc: Descriptor) -> Option<crate::CipDescriptor> {
    match desc {
        Descriptor::R => Some(crate::CipDescriptor::R),
        Descriptor::S => Some(crate::CipDescriptor::S),
        Descriptor::r => Some(crate::CipDescriptor::LowerR),
        Descriptor::s => Some(crate::CipDescriptor::LowerS),
        Descriptor::E => Some(crate::CipDescriptor::E),
        Descriptor::Z => Some(crate::CipDescriptor::Z),
        Descriptor::M => Some(crate::CipDescriptor::M),
        Descriptor::P => Some(crate::CipDescriptor::P),
        Descriptor::m => Some(crate::CipDescriptor::LowerM),
        Descriptor::p => Some(crate::CipDescriptor::LowerP),
        _ => None,
    }
}
