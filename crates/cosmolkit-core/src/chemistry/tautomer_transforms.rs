...
pub(super) const CURRENT_TAUTOMER_TRANSFORM_DEFINITIONS: &[TautomerTransformDefinition<'_>] = &[
    ...
    ("aliphatic imine f", "[CX4R{0-2}!H0]-[Cz1]=[NX2;N!H0,$(N-a)]", "", ""),
    ("aliphatic imine r", "[NX3;NH2,$([NH1]-a)]-[C;z{1-2}]=[CX3]", "", ""),
    ("special imine f", "[Nz0!H0]-[C]=[Cz0X3R0]", "", ""),
    ("special imine r", "[Cz0R0X4!H0]-[c]=[nz0]", "", ""),
    ("special imine r2", "[Cz0R0X4!H0]-[cr6](=[cr6])-[nr6H0z0]", "==-", ""),
    (
    ...
    ("furanone r", "[#6r5!H0;$([#6]([#6r5])[#6r5])][#6z2r5]=[O,S,N]", "", ""),
