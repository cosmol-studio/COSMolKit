//! QUARANTINED: rgroup — not compiled from lib.rs until properly re-ported.
...
#![allow(dead_code)]
pub(crate) fn quarantined_rgroup() -> ! {
    panic!("rgroup is quarantined: heuristic code without source reproduction is forbidden");
}
