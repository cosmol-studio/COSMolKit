//! QUARANTINED: mol_interchange — not compiled from lib.rs until properly re-ported.
...
#![allow(dead_code)]
pub(crate) fn quarantined_mol_interchange() -> ! {
    panic!("mol_interchange is quarantined: heuristic code without source reproduction is forbidden");
}
