//! QUARANTINED: descriptors — not compiled from lib.rs until properly re-ported.
...
#![allow(dead_code)]
pub(crate) fn quarantined_descriptors() -> ! {
    panic!("descriptors is quarantined: heuristic code without source reproduction is forbidden");
}
