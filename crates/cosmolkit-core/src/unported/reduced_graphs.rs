//! QUARANTINED: reduced_graphs — not compiled from lib.rs until properly re-ported.
...
#![allow(dead_code)]
pub(crate) fn quarantined_reduced_graphs() -> ! {
    panic!("reduced_graphs is quarantined: heuristic code without source reproduction is forbidden");
}
