//! QUARANTINED: mol_standardize — not compiled from lib.rs until properly re-ported.
...
#![allow(dead_code)]
pub(crate) fn quarantined_mol_standardize() -> ! {
    panic!("mol_standardize is quarantined: heuristic code without source reproduction is forbidden");
}
