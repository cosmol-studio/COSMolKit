//! QUARANTINED: shape_descriptors — not compiled from lib.rs until properly re-ported.
...
#![allow(dead_code)]
pub(crate) fn quarantined_shape_descriptors() -> ! {
    panic!("shape_descriptors is quarantined: heuristic code without source reproduction is forbidden");
}
