//! QUARANTINED: partial_charges — not compiled from lib.rs until properly re-ported.
...
#![allow(dead_code)]
pub(crate) fn quarantined_partial_charges() -> ! {
    panic!("partial_charges is quarantined: heuristic code without source reproduction is forbidden");
}
