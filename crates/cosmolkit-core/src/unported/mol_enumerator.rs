//! QUARANTINED: mol_enumerator — not compiled from lib.rs until properly re-ported.
...
#![allow(dead_code)]
pub(crate) fn quarantined_mol_enumerator() -> ! {
    panic!("mol_enumerator is quarantined: heuristic code without source reproduction is forbidden");
}
