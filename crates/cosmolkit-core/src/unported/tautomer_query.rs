//! QUARANTINED: tautomer_query — not compiled from lib.rs until properly re-ported.
...
#![allow(dead_code)]
pub(crate) fn quarantined_tautomer_query() -> ! {
    panic!("tautomer_query is quarantined: heuristic code without source reproduction is forbidden");
}
