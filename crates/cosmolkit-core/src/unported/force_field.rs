//! QUARANTINED: force_field — not compiled from lib.rs until properly re-ported.
...
#![allow(dead_code)]
pub(crate) fn quarantined_force_field() -> ! {
    panic!("force_field is quarantined: heuristic code without source reproduction is forbidden");
}
