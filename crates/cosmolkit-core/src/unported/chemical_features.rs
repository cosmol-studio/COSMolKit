//! QUARANTINED: chemical_features — not compiled from lib.rs until properly re-ported.
...
#![allow(dead_code)]
pub(crate) fn quarantined_chemical_features() -> ! {
    panic!("chemical_features is quarantined: heuristic code without source reproduction is forbidden");
}
