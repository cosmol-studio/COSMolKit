//! QUARANTINED: chem_transforms — not compiled from lib.rs until properly re-ported.
...
#![allow(dead_code)]
pub(crate) fn quarantined_chem_transforms() -> ! {
    panic!("chem_transforms is quarantined: heuristic code without source reproduction is forbidden");
}
