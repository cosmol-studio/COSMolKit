//! QUARANTINED: fmcs — not compiled from lib.rs until properly re-ported.
...
#![allow(dead_code)]
pub(crate) fn quarantined_fmcs() -> ! {
    panic!("fmcs is quarantined: heuristic code without source reproduction is forbidden");
}
