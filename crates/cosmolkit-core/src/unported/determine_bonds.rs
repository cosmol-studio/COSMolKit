//! QUARANTINED: determine_bonds — not compiled from lib.rs until properly re-ported.
...
#![allow(dead_code)]
pub(crate) fn quarantined_determine_bonds() -> ! {
    panic!("determine_bonds is quarantined: heuristic code without source reproduction is forbidden");
}
