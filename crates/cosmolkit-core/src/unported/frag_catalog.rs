//! QUARANTINED: frag_catalog — not compiled from lib.rs until properly re-ported.
...
#![allow(dead_code)]
pub(crate) fn quarantined_frag_catalog() -> ! {
    panic!("frag_catalog is quarantined: heuristic code without source reproduction is forbidden");
}
