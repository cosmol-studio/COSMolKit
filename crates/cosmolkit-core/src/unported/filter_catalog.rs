//! QUARANTINED: filter_catalog — not compiled from lib.rs until properly re-ported.
...
#![allow(dead_code)]
pub(crate) fn quarantined_filter_catalog() -> ! {
    panic!("filter_catalog is quarantined: heuristic code without source reproduction is forbidden");
}
