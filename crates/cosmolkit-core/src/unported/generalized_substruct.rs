//! QUARANTINED: generalized_substruct — not compiled from lib.rs until properly re-ported.
...
#![allow(dead_code)]
pub(crate) fn quarantined_generalized_substruct() -> ! {
    panic!("generalized_substruct is quarantined: heuristic code without source reproduction is forbidden");
}
