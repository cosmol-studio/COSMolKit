//! QUARANTINED: substruct_library — not compiled from lib.rs until properly re-ported.
...
#![allow(dead_code)]
pub(crate) fn quarantined_substruct_library() -> ! {
    panic!("substruct_library is quarantined: heuristic code without source reproduction is forbidden");
}
