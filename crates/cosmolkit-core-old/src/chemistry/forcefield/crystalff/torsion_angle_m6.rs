...
use crate::chemistry::forcefield::crystalff::calc_torsion_energy_m6;
...
impl TorsionAngleContribM6 {
    ...
    pub fn new(
        ...
        // RDKit✔️✔️: TorsionAngleContribM6::TorsionAngleContribM6(
        // RDKit✔️✔️:     ForceFields::ForceField *owner, unsigned int idx1, unsigned int idx2,
        // RDKit✔️✔️:     unsigned int idx3, unsigned int idx4, std::vector<double> V,
        // RDKit✔️✔️:     std::vector<int> signs)
        // RDKit✔️✔️:     : ForceFieldContrib(owner),
        // RDKit✔️✔️:       d_at1Idx(idx1),
        // RDKit✔️✔️:       d_at2Idx(idx2),
        // RDKit✔️✔️:       d_at3Idx(idx3),
        // RDKit✔️✔️:       d_at4Idx(idx4),
        // RDKit✔️✔️:       d_V(std::move(V)),
        // RDKit✔️✔️:       d_sign(std::move(signs)) {
    ...
    pub fn get_energy(&self, pos: &[f64]) -> f64 {
        ...
        // RDKit✔️✔️: double TorsionAngleContribM6::getEnergy(double *pos) const {
        ...
        // RDKit✔️✔️:
        // RDKit✔️✔️:   return calcTorsionEnergyM6(
        // RDKit✔️✔️:       d_V, d_sign, Utils::calcTorsionCosPhi(iPoint, jPoint, kPoint, lPoint));
        ...
        let energy = calc_torsion_energy_m6(&self.force_constants, &self.signs, cos_phi);
        // RDKit✔️✔️: }
        energy
    }
    ...
    pub fn get_grad(&self, pos: &[f64], grad: &mut [f64]) {
        ...
        // RDKit✔️✔️: void TorsionAngleContribM6::getGrad(double *pos, double *grad) const {
        // RDKit✔️✔️:   PRECONDITION(dp_forceField, "no owner");
        assert!(!self.owner.is_null(), "no owner");
        // RDKit✔️✔️:   PRECONDITION(pos, "bad vector");
        assert!(!pos.is_empty(), "bad vector");
        ...
        // RDKit✔️✔️:   if (isDoubleZero(d[0]) || isDoubleZero(d[1])) {
        // RDKit✔️✔️:     return;
        // RDKit✔️✔️:   }
        ...
        // RDKit✔️✔️:   double cosPhi4 = cosPhi * cosPhi3;
        let cos_phi4 = cos_phi * cos_phi3;
        // RDKit✔️✔️:   double cosPhi5 = cosPhi * cosPhi4;
...
mod tests {
    ...
    fn crystalff_torsion_angle_m6_get_energy_and_grad_match_collection_contrib() {
        ...
        let contrib_energy = contrib.get_energy(&pos);
        let collection_energy = collection.get_energy(&pos);
        contrib.get_grad(&pos, &mut contrib_grad);
