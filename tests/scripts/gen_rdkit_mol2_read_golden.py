...
def main() -> None:
    ...
    parser.add_argument(
        "--input",
        type=Path,
        default=Path("tests/fixtures/mol2/rdkit"),
        help=(
            "input MOL2 fixture directory (default: tests/fixtures/mol2/rdkit). "
            "When the unified golden runner passes tests/smiles.smi, this script "
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("tests/golden/mol2_read.jsonl"),
        help="output JSONL path (default: tests/golden/mol2_read.jsonl)",
    )
    parser.add_argument(
        "--limit",
        type=int,
    ...
    if input_dir.is_file():
        input_dir = Path("tests/fixtures/mol2/rdkit")
