...
Step 179 [x]: Update current public Rust docs, Python docs, stubs, examples, README feature summaries, and `dev/parity_scope.md` to describe the same project-native AtomPair surface and verified corpus evidence without editing historical plans.
