...
The copied files retain RDKit's BSD-3-Clause license context. The manifest
also records checksums for the upstream source tests used to define fixture
selection and behavior coverage.
