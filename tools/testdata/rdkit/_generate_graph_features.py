#!/usr/bin/env python3
"""Generate RDKit graph-feature golden data from testdata/smiles/corpus/smiles_small.smi."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("testdata/graph/expected/rdkit/smiles_small/graph_features.jsonl"),
        help="output JSONL path (default: testdata/graph/expected/rdkit/smiles_small/graph_features.jsonl)",
    )
