#!/usr/bin/env python3
"""Generate RDKit PrepareMolForDrawing golden data for testdata/smiles/corpus/smiles_small.smi."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("testdata/depiction/expected/rdkit/smiles_small/prepared_draw_molecule.jsonl"),
        help="output JSONL path (default: testdata/depiction/expected/rdkit/smiles_small/prepared_draw_molecule.jsonl)",
    )
