...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("testdata/fingerprint/expected/rdkit/smiles_small/morgan_fingerprint.jsonl"),
        help="output JSONL path (default: testdata/fingerprint/expected/rdkit/smiles_small/morgan_fingerprint.jsonl)",
    )
