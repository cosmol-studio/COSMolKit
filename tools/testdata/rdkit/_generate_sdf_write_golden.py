...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("testdata/sdf/expected/rdkit/smiles_small/sdf_write.jsonl"),
        help="output JSONL path (default: testdata/sdf/expected/rdkit/smiles_small/sdf_write.jsonl)",
    )
    parser.add_argument(
        "--jobs",
        type=int,
