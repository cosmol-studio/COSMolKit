...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("testdata/kekulize/expected/rdkit/smiles_small/kekulize_clear_flags_false.jsonl"),
        help="output JSONL path (default: testdata/kekulize/expected/rdkit/smiles_small/kekulize_clear_flags_false.jsonl)",
    )
