...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("testdata/xyz/expected/rdkit/smiles_small/xyz_read.jsonl"),
        help="output JSONL path (default: testdata/xyz/expected/rdkit/smiles_small/xyz_read.jsonl)",
    )
