...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("testdata/smiles/expected/rdkit/smiles_small/isomeric_smiles.jsonl"),
        help="output JSONL path (default: testdata/smiles/expected/rdkit/smiles_small/isomeric_smiles.jsonl)",
    )
