...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="input smiles corpus (default: testdata/smiles/corpus/smiles_small.smi)",
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("testdata/molblock/expected/rdkit/smiles_small/molblock_v2000_kekulized.jsonl"),
        help="output jsonl (default: testdata/molblock/expected/rdkit/smiles_small/molblock_v2000_kekulized.jsonl)",
    )
