#!/usr/bin/env python3
"""Generate RDKit single-conformer library golden data from testdata/smiles/corpus/smiles_small.smi."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("testdata/conformer/expected/rdkit/smiles_small/conformer_generation_library.jsonl"),
        help="output JSONL path (default: testdata/conformer/expected/rdkit/smiles_small/conformer_generation_library.jsonl)",
    )
