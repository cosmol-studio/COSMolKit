#!/usr/bin/env python3
"""Generate RDKit MolDraw2DSVG golden data for testdata/smiles/corpus/smiles_small.smi."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("testdata/depiction/expected/rdkit/smiles_small/svg_drawer.jsonl"),
        help="output JSONL path (default: testdata/depiction/expected/rdkit/smiles_small/svg_drawer.jsonl)",
    )
