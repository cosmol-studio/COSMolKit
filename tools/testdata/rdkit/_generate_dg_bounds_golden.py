...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("testdata/distgeom/expected/rdkit/smiles_small/dg_bounds_matrix.jsonl"),
        help="output JSONL path (default: testdata/distgeom/expected/rdkit/smiles_small/dg_bounds_matrix.jsonl)",
    )
